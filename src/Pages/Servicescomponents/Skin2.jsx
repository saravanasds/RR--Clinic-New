...
const Skin2 = () => {
  ...
  return (
    ...
    <div className="relative w-[95%] lg:w-[90%] m-auto min-h-[500px] mt-5 mb-20 bg-gradient-to-r from-red-300 to-red-100 border-2 border-red-300 rounded-lg shadow-lg shadow-red-100">
