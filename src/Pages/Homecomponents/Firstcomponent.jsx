...
const Firstcomponent = () => {
  return (
    ...
    <div className="flex flex-col justify-center items-center font-sen text-bold gap-2 p-4 rounded-2xl bg-gradient-to-r from-[#d864e2] to-[hsl(302,33%,95%)] shadow-clay-card hover:clay-btn">
