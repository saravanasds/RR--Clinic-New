...
const Fourthcomponent = () => {
  ...
  return (
    <>
      <div>
        <div
          className="flex justify-end  items-start pt-20 w-[100%] h-screen "
          style={{
        ...
        >
          <div className="w-[40%]   flex flex-col justify-end items-end gap-5 mr-5">
            <h2
              ...
              style={{ textShadow: "2px 2px 4px rgb(59,132,263)" }}
            >
              "Book Your Free Consultation Now and
            </h2>
            <h2
           className="text-4xl font-bold text-pink-500"
           style={{ textShadow: "2px 2px 4px rgb(59,132,263)" }}
            >
              {" "}
              Get Ready to Rediscover Confidence!"
            </h2>
           
          </div>
        </div>
        <div className="w-[100%] p-5">
          <h2 className="text-6xl text-center font-semibold ">Treatments</h2>
          <div className="flex justify-c enter items-center py-10">
            <div className="grid grid-cols-3 gap-10 px-10">
              ...
              <div className="relative w-[400px] h-[300px] shadow-sm shadow-black flex justify-center items-center bg-blue-300 font-medium text-lg overflow-hidden">
                {open2 && (
                  <h2
                    className={`absolute text-white text-xl bg-[rgba(0,0,0,0.6)] w-full h-full flex justify-center items-center z-10 pointer-events-none ${
                      open2 ? "animate-slideUp" : "animate-slideDown"
                    }`}
                  >
              ...
              <div className="relative w-[400px] h-[300px] shadow-sm shadow-black flex justify-center items-center bg-blue-300 font-medium text-lg overflow-hidden">
                {open3 && (
                  <h2
                    className={`absolute text-white text-xl bg-[rgba(0,0,0,0.6)] w-full h-full flex justify-center items-center z-10 pointer-events-none ${
                      open3 ? "animate-slideUp" : "animate-slideDown"
                    }`}
                  >
              ...
              <div className="relative w-[400px] h-[300px] shadow-sm shadow-black flex justify-center items-center bg-blue-300 font-medium text-lg overflow-hidden">
                {open4 && (
                  <h2
                    className={`absolute text-white text-xl bg-[rgba(0,0,0,0.6)] w-full h-full flex justify-center items-center z-10 pointer-events-none ${
                      open4 ? "animate-slideUp" : "animate-slideDown"
                    }`}
                  >
              ...
              <div className="relative w-[400px] h-[300px] shadow-sm shadow-black flex justify-center items-center bg-blue-300 font-medium text-lg overflow-hidden">
                {open5 && (
                  <h2
                    className={`absolute text-white text-xl bg-[rgba(0,0,0,0.6)] w-full h-full flex justify-center items-center z-10 pointer-events-none ${
                      open5 ? "animate-slideUp" : "animate-slideDown"
                    }`}
                  >
                    Percutaneous FUE
                  </h2>
